"""MlsGrid missing Sold Date Utillity Download Lambda"""
...
logger = logging.getLogger("mls-grid-missing-sold-date-utility")
...
def sold_date_update(
    listing_cursor, source_id, auth, ls_connection, originating_system_name
):
