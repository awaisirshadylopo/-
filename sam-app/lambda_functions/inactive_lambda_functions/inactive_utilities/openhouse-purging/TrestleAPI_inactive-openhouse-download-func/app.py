"""Trestle API Validation and Data Download"""
...
def download_all_Openhouse_func(
    ...
    originating_system_name = source_data["source_info"]["originating_system_name"]
    ...
    # -------------------------------------------------------------
    # 2. Build Trestle OpenHouse API endpoint and headers
    # -------------------------------------------------------------

    headers = {"Authorization": f"Bearer {token}"}
    loginurl = loginurl.replace("connect/token", "").replace("oidc", "odata")
    ...
    params = {
        "$filter": f"OriginatingSystemName eq {originating_system_name} and OpenHouseDate ge {last_day_time}",
    ...
    # -------------------------------------------------------------
    # 4. Call Trestle API and handle OData pagination
    # -------------------------------------------------------------
