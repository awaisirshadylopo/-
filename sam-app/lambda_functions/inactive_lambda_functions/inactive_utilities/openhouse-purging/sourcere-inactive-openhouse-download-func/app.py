"""SourceRE API Validation and Data Download"""
...
def process_openhouse_data(
    ...
    try:
        ...
        VALUES (%(source_id)s, %(batch_id)s, %(ListingKey)s, %(openhousestarttime)s, %(openhousestarttime)s, %(openhouseendtime)s, %(y_creation_date)s, %(y_update_date)s)
        """
        # Execute the insert
        try:
...
def download_all_Openhouse_func(
    ...
    Created: 2026-02-25               Create By : Muhammad Fasihuddin
    """
