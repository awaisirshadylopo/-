# SourceRE metadata download lambda
...
def ddl_generation(source_id, metadata_url, connection, cursor):
    ...
    for each_table in ps_tables_name:
        ...
        table = f"idx_stage.ps_sourcere_{each_table}_{source_id}" if each_table != 'Medias' else f"idx_stage.ps_sourcere_{each_table}"
        # if not metadata_url.__contains__('sourcereapi'):
